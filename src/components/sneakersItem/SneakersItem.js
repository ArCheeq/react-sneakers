...
const SneakersItem = ({id, src, price, title, cart, favorite}) => {
    ...
    return (
        <div className="sneakers__item" key={id}>
            <button className='like' onClick={() => onToggleSneakers('favorite')}>
            ...
            <button className="toCartBtn" onClick={() => onToggleSneakers('cart')}>
